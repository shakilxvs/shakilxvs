...
export async function addPortalProject(data) {
  try {
    const ref = await addDoc(collection(db, 'portal_projects'), { ...data, createdAt: serverTimestamp() });
    return ref.id;
...
export async function updatePortalProject(id, data) {
  try {
    await updateDoc(doc(db, 'portal_projects', id), { ...data, updatedAt: serverTimestamp() });
    return true;
...
export async function addTask(data) {
  try {
    const ref = await addDoc(collection(db, 'portal_tasks'), { ...data, createdAt: serverTimestamp() });
    return ref.id;
...
export async function updateTask(id, data) {
  try {
    await updateDoc(doc(db, 'portal_tasks', id), { ...data, updatedAt: serverTimestamp() });
    return true;
...
export async function addInvoice(data) {
  try {
    const ref = await addDoc(collection(db, 'portal_invoices'), { ...data, createdAt: serverTimestamp() });
    return ref.id;
...
export async function updateInvoice(id, data) {
  try {
    await updateDoc(doc(db, 'portal_invoices', id), { ...data, updatedAt: serverTimestamp() });
    return true;
...
export async function addPortalFile(data) {
  try {
    const ref = await addDoc(collection(db, 'portal_files'), { ...data, createdAt: serverTimestamp() });
    return ref.id;
...
export async function getPublishedDailyPosts() {
  ...
  } catch (e) { console.error('getPublishedDailyPosts:', e); return []; }
}

export async function getAllDailyPosts() {
  try {
    const snap = await getDocs(collection(db, 'daily_posts'));
    return snap.docs.map(d => ({ id: d.id, ...d.data() }))
      .sort((a, b) => {
        const at = a.createdAt?.seconds ?? 0;
        const bt = b.createdAt?.seconds ?? 0;
  ...
  } catch (e) { console.error('getAllDailyPosts:', e); return []; }
}

export async function addDailyPost(data) {
  try {
    const ref = await addDoc(collection(db, 'daily_posts'), {
      ...data, createdAt: serverTimestamp(),
    });
    return ref.id;
  } catch (e) { console.error('addDailyPost:', e); throw e; }
}

export async function updateDailyPost(id, data) {
  try {
    await updateDoc(doc(db, 'daily_posts', id), { ...data, updatedAt: serverTimestamp() });
    return true;
  } catch (e) { console.error('updateDailyPost:', e); throw e; }
}

export async function deleteDailyPost(id) {
  try {
    await deleteDoc(doc(db, 'daily_posts', id));
    return true;
  } catch (e) { console.error('deleteDailyPost:', e); throw e; }
}
...
export async function updateBlogPost(id, data) {
  try {
    await updateDoc(doc(db, 'blog_posts', id), { ...data, updatedAt: serverTimestamp() });
    return true;
