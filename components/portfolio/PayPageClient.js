...
function LogoPill({ src, alt, invert, size = 'section' }) {
  ...
  return (
    <div title={alt} className="pay-icon-bg" style={{
      height: h, padding: p,
              ...
              {PLATFORMS.map(p => {
                ...
                return (
                  <div key={p.key} style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto', alignItems: 'center', gap: '12px', padding: '14px 16px', background: 'var(--bg-elevated)', border: '1px solid var(--border-1)', borderRadius: 'var(--radius-lg)' }}>
                    <div style={{ width: 44, height: 44, borderRadius: 'var(--radius-md)', background: '#0b0e1a', border: '1px solid rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }} className="pay-icon-bg">
                      {p.logoUrl
                  ...
                  <div key={c.id} style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-1)', borderRadius: 'var(--radius-lg)', padding: '18px', display: 'grid', gridTemplateColumns: c.qrImageUrl ? '1fr auto' : '1fr', gap: '16px', alignItems: 'start' }}>
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                        {src && <div style={{ width: 36, height: 36, borderRadius: '50%', background: '#0b0e1a', border: '1px solid rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }} className="pay-icon-bg">
