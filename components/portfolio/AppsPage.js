...
function AppCard({ app, featured = false }) {
  ...
  const inner = (
    <div style={{
      ...
      alignItems: featured ? 'center' : 'center',
      gap: featured ? '24px' : '14px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', justifyContent: featured ? 'flex-start' : 'center', flexWrap: 'wrap' }}>
          ...
          {featured && app.url && (
            <span style={{
              ...
              fontFamily: 'Outfit, sans-serif', fontSize: '0.8rem', color: 'var(--text-3)',
            }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        ...
        {loading ? (
          ...
          <>
            ...
            {regular.length > 0 && (
              <>
                {featured && <div style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.6rem', color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '12px' }}>All Apps</div>}
